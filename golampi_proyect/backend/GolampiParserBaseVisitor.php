...
/**
 * This class provides an empty implementation of {@see GolampiParserVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class GolampiParserBaseVisitor extends AbstractParseTreeVisitor implements GolampiParserVisitor
{
	/**
	 * {@inheritdoc}
	 *
